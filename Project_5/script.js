...
// tododes.setAttribute(`id`,`des${count}`);
...
todosHeading.addEventListener("click",()=>{
    // secondpage(todosHeading,newtodo);
    todos.style.display="none";
    var secondpages=document.getElementsByClassName("secondpages")
    // secondpages.style.display="flex"
